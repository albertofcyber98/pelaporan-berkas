...
<body id="page-top">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center align-middle">
                                                    <a href="" type="button" data-toggle="modal" data-target="#modalHapusPelaporan<?php echo $dataPelaporanTidak['id']; ?>" class="btn btn-danger btn-circle btn-sm"><i class="far fa-times-circle"></i></a>
                                                </td>
                                                <!-- Modal Hapus-->
    ...
    <?php
        if(isset($_POST['submit'])){
            if(tambahdatapengajuan($_POST)>0){
                echo'
